       ...
       <div class="bar"></div>
		<div class="footer" > 
             ...
             <ul>
				 ...
				 <form method="post" action="admin_m.php" style="text-align:right;padding-left:10px">
				 Email : <input type="email" id="e" name="e" style="padding-right: 271px;">
				 <br/>
				 <br/>
				 Message : <textarea rows="4" cols="50" id="msg" name="msg">

</textarea>
                <input type="submit" name="msssg" value="Send">
