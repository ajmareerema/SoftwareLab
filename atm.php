...
<html>
	...
	<!--navigation bar section-->
		...
		<h1 style="text-align:center;text-decoration: underline overline;color:blue;">ATM Service Taking Form Fill Up</h1>
		
		<!--Service section-->
		
		<div class="services">
		
		<form method="post" action="a.php" style="text-align:center; padding-top: 180px;">
